...
<div class="login-container">
    <div class="login-card">
        <div class="login-header">
            ...
            <p class="login-subtitle">Silahkan login kembali</p>
        </div>
        ...
        <form method="POST" action="{{ route('login-action') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" id="nim" name="nim" class="form-input" placeholder="Masukan NIM" required>
            </div>
